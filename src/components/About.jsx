...
import { History, Target, Users, Award, Ship, Package } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-primary-100 rounded-lg -z-10" />
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8 lg:p-12 shadow-xl">
              ...
              >
                Transcom International Shipping & Logistics
              </motion.h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                {[
                  "Transcom International Shipping & Logistics is a leading international logistics and shipping company, offering one-window solutions to our valued clients in the logistics and shipping industry.",
                  "We have built our reputation on trust, reliability, and excellence in service delivery. Our commitment to providing seamless logistics solutions has made us a preferred partner for businesses worldwide.",
                  "Our foundation was laid with a vision to connect the world through efficient and reliable shipping services. In a short span of time, we have expanded our global reach with offices in key transshipment hubs across the world.",
                  "Transcom International Shipping & Logistics is here to provide you solutions for all your shipping needs, ensuring your cargo reaches its destination safely and on time."
                ].map((text, index) => (
                  <motion.p
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            >
              <motion.img 
                ...
                alt="Global Shipping Excellence" 
              ...
              <div className="absolute inset-0 flex items-end justify-center pb-8 z-10">
                ...
                >
                  <motion.h3 
                    className="text-2xl font-bold mb-4 drop-shadow-2xl"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {[
                ...
                "As Transcom International Shipping & Logistics strives to be a true integrator of container logistics, we connect and simplify our customers' supply chain through global end-to-end solutions. We make our customers' lives easier by managing the entire product journey, including:"
              ].map((text, index) => (
                <motion.p
                  key={index}
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {[
                  ...
                  { icon: Package, label: 'Warehouse Management' },
                  { icon: Target, label: 'Inland Services' },
                  { icon: Award, label: 'Customs Services' },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                ...
                <div className="absolute inset-0 flex items-end justify-center pb-8 z-10">
                  ...
                  >
                    ...
                    <motion.p 
                      ...
                      transition={{ duration: 0.5, delay: 0.4 }}
                    >
                      Your complete logistics partner
                    </motion.p>
                  </motion.div>
                </div>
                {/* Glow Effect */}
                <motion.div
                  className="absolute inset-0 border-4 border-accent-400/50 rounded-2xl"
                  animate={{
                    boxShadow: [
